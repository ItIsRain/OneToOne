...
export const metadata: Metadata = {
  title: "Next.js Badge | One to One by Lunar Labs - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for One to One by Lunar Labs - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
