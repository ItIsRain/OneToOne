          ...
          <div className="grid grid-cols-2 gap-2">
            {category.fields.map((field) => (
              <button
                ...
                className="flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-left text-xs font-medium text-gray-700 shadow-sm hover:bg-gray-50 hover:border-brand-300 transition dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
              >
