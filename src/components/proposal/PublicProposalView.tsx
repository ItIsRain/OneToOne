      ...
      <div className="mx-auto max-w-4xl space-y-10 px-4 py-8 sm:px-6 lg:px-8">
        {sortedSections.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-lg font-medium text-gray-500 dark:text-gray-400">This proposal has no content yet.</p>
            <p className="mt-1 text-sm text-gray-400 dark:text-gray-500">The proposal is still being prepared.</p>
          </div>
        ) : (
